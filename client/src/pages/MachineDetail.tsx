    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#f5f5f5]">
        ...
        <main className="flex-1 flex items-center justify-center pt-20 lg:pt-[124px]">
          <Loader2 className="w-10 h-10 animate-spin text-[#FFF100]" />
        </main>
        <Footer />
      </div>
    );
        ...
        <div className="max-w-[1224px] mx-auto px-5 sm:px-8 py-8 lg:py-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a href="tel:+4586470388" className="flex-1">
                    <button className="w-full inline-flex items-center justify-center gap-2 bg-[#FFF100] text-[#1a1a1a] text-[14px] font-semibold px-6 py-3 rounded-full hover:bg-[#e6da00] transition-colors">
                      <Phone className="w-4 h-4" />
                      Ring: 25 15 94 95
                    </button>
                  </a>
                  <a
                    href={`mailto:mail@iem.dk?subject=Forespørgsel: ${machine.brand} ${machine.model} (ID: ${machine.id})&body=Hej,%0D%0A%0D%0AJeg er interesseret i følgende maskine:%0D%0A%0D%0A${machine.brand} ${machine.model}%0D%0APris: ${formatPrice(machine.price)} ${machine.currency}%0D%0AID: ${machine.id}%0D%0A%0D%0AMed venlig hilsen`}
                    className="flex-1"
                  >
          ...
          <div className="mt-10 lg:mt-14 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <SpecItem label="Forhandler" value="Ib E. Mortensen A/S" />
                <SpecItem label="Kontaktperson" value={machine.contact || 'Mads Kroon Uldall Juhl'} />
                <SpecItem label="Adresse" value={machine.address || 'Vesterbro 73, DK-8970 Havndal'} />
                <SpecItem label="Telefon" value="25 15 94 95" />
                <SpecItem label="Email" value="mail@iem.dk" />
              </div>
            </div>
          </div>
        </div>
